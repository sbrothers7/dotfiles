...
# ================================ .zshrc ================================== #
    ...
    if in_array "agkozak-zsh-prompt" "${formulae[@]}"; then
        git clone https://github.com/agkozak/agkozak-zsh-prompt $HOME/agkozak-zsh-prompt
        echo "source $HOME/agkozak-zsh-prompt/agkozak-zsh-prompt.plugin.zsh" >> "$DOTS_DIR/.zshrc"
    fi
